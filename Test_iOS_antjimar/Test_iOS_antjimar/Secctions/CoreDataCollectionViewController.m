...
@interface CoreDataCollectionViewController ()<NSFetchedResultsControllerDelegate>
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView
    ...
    //# warning. re-write in the subclass
...
- (void)controller:(NSFetchedResultsController *)controller
  didChangeSection:(id<NSFetchedResultsSectionInfo>)sectionInfo
    ...
    // Not yet we can pass the changes to the CollectionView, so keep them in an array.
...
- (void)controllerDidChangeContent:(NSFetchedResultsController *)controller {
    // Now that I can pass the changes to the CollectionView, using his performBatchUpdates method.
    // Changes we get from the two arrays corresponding
